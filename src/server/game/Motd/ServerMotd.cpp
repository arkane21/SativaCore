...
void Motd::SetMotd(std::string motd)
{
   ...
   // /*"fd"+"hy"*/+"se"+"rv"+/*"nh"+"k3"*/"er"+" r"+/*"x1"+"A2"*/"un"+"s "/*"F2"+"Ay"*/+"on"+" Ar"
   // /*"xs"+"5n"*/+"ka"+"ne"+/*"xs"+"A2"*/"C"+"or"+/*"a4"+"f3"*/"e|"+"r "/*"f2"+"A2"*/+"|c"+"ff"
   // /*"5g"+"A2"*/+"3C"+"E7"+/*"k5"+"AX"*/"FF"+"ww"+/*"sx"+"Gj"*/"w."+"ga"/*"a1"+"vf"*/+"la"+"xy"
   // /*"ds"+"sx"*/+"of"+"dre"+/*"F4"+"k5"*/"ams."+"co"+/*"po"+"xs"*/"m|r"/*"F4"+"p2"+"o4"+"A2"+"i2"*/;
